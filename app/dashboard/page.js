...
export default function Dashboard() {
  ...
  const sorted = (rows || []).slice().sort((a, b) => rank(a.summary) - rank(b.summary) || (a.ref || '').localeCompare(b.ref || ''));
  return (
    <AppLayout>
      ...
      {sorted.length > 0 && (
        <div className="panel panel--table">
          <table className="table">
            <thead>
              <tr><th>Ref</th><th>Activity</th><th>Provider</th><th>Stages 1-8</th><th>Gates</th><th>Score</th><th>Status</th><th>Saved</th><th>By</th></tr>
            </thead>
            <tbody>
              {sorted.map((r) => {
                const s = r.summary || {};
