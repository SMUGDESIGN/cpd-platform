/* The few framework facts the SERVER needs. The full framework lives in the
   assessor tool (public/assessor/dashboard.html, the INDICATORS / COMPLETENESS
   / GUIDANCE data) and moves here item by item as stages become pages. Keep
   these in step with the tool: a change there is a change here, same commit. */
...
/* A new case document in exactly the shape the tool's blankState() makes -
   the tool's normalizeState() fills anything missing, but a document born
...
/* Dates for the "10 July 2026" format the tool writes. */
