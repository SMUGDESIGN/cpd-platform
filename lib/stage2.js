/* Stages 2-4 - the indicator matrix - as pure functions. Rating rules ported
   from the tool's buildIndicatorRows / refreshDerivation / compute:
...
/* Mirror of the tool's refreshDerivation(): 1.4.3 follows the calculator while the
