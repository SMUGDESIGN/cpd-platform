/* Stage 7 - the outcome - as pure functions over the case document: the
   verdict words for each computed outcome, the signed
...
/* The words under the verdict, one branch per computed outcome. */
